...
/*
 * ChronogramView2.java
 *
 * Created on 21-may-2010, 13:06:46
 */
...
public class ChronogramView extends javax.swing.JFrame {
    ...
    private void drawValuesAndSignals(Graphics g /*float i1, float i2, String value, int cx, int cy*/){

        int height = 20; //ancho rectangulo
        Color c = Color.BLACK;
        Color colorAnt = c;
        float int1;
        float int2;
        ...
        for (int i=0; i < this.cursor; i++){
           ...
           fin = svi.getCursor();
           coordX = 100; // porque es donde empieza el primer intervalo
